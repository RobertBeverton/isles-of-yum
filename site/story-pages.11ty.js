...
export const data = {
  ...
  eleventyComputed: {
    ...
    keyIslands: (data) => data.stories.bySlug[data.storyPage.data.storySlug]?.keyIslands ?? [],
    characters: (data) => data.stories.bySlug[data.storyPage.data.storySlug]?.characters ?? [],
